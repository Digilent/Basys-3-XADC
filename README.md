...
2. Open the project in Vivado 2020.1 by double clicking on the included XPR file found at "\<archive extracted location\>/Basys-3-XADC/Basys-3-XADC.xpr".
...
7. In the Program Device Wizard, enter "\<archive extracted location\>Basys-3-XADC/Basys-3-XADC.runs/impl_1/XADCdemo.bit" into the "Bitstream file" field. Then click **Program**.
